...
change_color() {
	...
	sed -i -e "s/red = #.*/red = #${RD}/g" $PFILE
	sed -i -e "s/green = #.*/green = #${GR}/g" $PFILE
	sed -i -e "s/yellow = #.*/yellow = #${YE}/g" $PFILE
	sed -i -e "s/blue = #.*/blue = #${BL}/g" $PFILE
	sed -i -e "s/purple = #.*/purple = #${PU}/g" $PFILE
	sed -i -e "s/aqua = #.*/aqua = #${AQ}/g" $PFILE
	sed -i -e "s/orange = #.*/orange = #${OR}/g" $PFILE
